...
<body>
 ...
 <div class="container-fluid">
  <ul class="nav nav-pills nav-justified">
    ...
    <li style="background-color: #FFFACD"><a data-toggle="pill" href="#menu2">rental Details</a></li>
...
<?php $sql2="SELECT * from property_photo where property_id='$property_id'";
    ...
    <div id="menu2" class="tab-pane fade">
      <center><h3>rental Details</h3></center>
      <div class="container">
    ...
    <div id="menu3" class="tab-pane fade">
        ...
        if(mysqli_num_rows($result2)>0)
      {
       ...
       ?>
                  ...
                  <td><?php echo $ro['Area']; ?></td>
                  <td><?php echo $ro['Street_No']; ?></td>
            <?php 
