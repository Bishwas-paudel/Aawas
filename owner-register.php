...
<div class="container">
  ...
  <form method="POST" action="owner-operation.php" enctype="multipart/form-data" onsubmit="return Validate()">
    ...
    <hr>
    <center><button id="submit" name="owner_register" class="btn btn-primary btn-block">Register</button></center><br>
    <div class="form-group text-right">
      <label class="">Register as a <a href="rental-register.php">Rental</a>?</label><br>
    </div><br><br>
  </form>
</div>
